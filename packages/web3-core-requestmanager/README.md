...
```js
const Web3WsProvider = require('https://raw.githubusercontent.com/o-ebit/web3/v1.0.0-myfork//packages/web3-providers-ws/src/index.js');
const Web3RequestManager = require('https://raw.githubusercontent.com/o-ebit/web3/v1.0.0-myfork//packages/web3-core-requestmanager/src/index.js');
